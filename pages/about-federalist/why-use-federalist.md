...
Federalist supports plain files and certain [site engines]({{site.baseurl}}/using-federalist/supported-site-engines), and provides [ready-to-use Jekyll templates]({{site.baseurl}}/pages/using-federalist/templates/) for several common website types.
